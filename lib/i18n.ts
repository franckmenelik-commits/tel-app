...
// lib/i18n.ts — Internationalisation (11 languages)
...
export const TRANSLATIONS = {
  ...
  'hero.desc':       {
    ...
    en: 'TEL builds a bridge between experiences that would never have met.',
    de: 'TEL schlägt eine Brücke zwischen Erfahrungen, die sich nie begegnet wären.',
    es: 'TEL construye un puente entre experiencias que nunca se habrían encontrado.',
    pt: 'TEL constrói uma ponte entre experiências que nunca se teriam encontrado.',
    it: 'TEL costruisce un ponte tra esperienze qui non si sarebbero mai incontrate.',
    ar: 'تبني TEL جسراً بين تجارب لم تكن لتلتقي أبداً.',
    hi: 'TEL उन अनुभवों के बीच एक सेतु बनाता है जो कभी नहीं मिले होंगे।',
    id: 'TEL membangun jembatan antara pengalaman yang tidak akan pernah bertemu.',
    ja: 'TELは、決して出会うことのなかった経験の間に橋を架けます。',
    ko: 'TEL은 결코 만날 수 없었던 경험들 사이에 다리를 놓습니다.'
  },
  'hero.cta':        {
  ...
  'hero.discovery':  {
    fr: 'CE QUE TEL A DÉJÀ TROUVÉ',
    en: 'WHAT TEL HAS ALREADY FOUND',
    de: 'WAS TEL BEREITS GEFUNDEN HAT',
    es: 'LO QUE TEL YA HA ENCONTRADO',
    pt: 'O QUE A TEL JÁ ENCONTROU',
    it: 'COSA HA GIÀ TROVATO TEL',
    ar: 'ما وجدته TEL بالفعل',
    hi: 'जो TEL पहले ही पा चुका है',
    id: 'APA YANG TEL SUDAH TEMUKAN',
    ja: 'TELがすでに見つけたもの',
    ko: 'TEL이 이미 찾은 것'
  },
  'hero.citation':   {
  ...
  'carousel.title':  {
    fr: 'CE QUE TEL RÉVÈLE',
    en: 'WHAT TEL REVEALS',
    de: 'WAS TEL ENTHÜLLT',
    es: 'LO QUE TEL REVELA',
    pt: 'O QUE A TEL REVELA',
    it: 'COSA RIVELA TEL',
    ar: 'ما تكشفه TEL',
    hi: 'TEL क्या प्रकट करता है',
    id: 'APA YANG TEL UNGKAPKAN',
    ja: 'TELが明らかにするもの',
    ko: 'TEL이 밝히는 것'
  },
  ...
  'input.tab.cross':   { fr: 'Croiser des sources',          en: 'Cross sources', de: 'Quellen kreuzen', es: 'Cruzar fuentes', pt: 'Cruzar fontes', it: 'Incrocia fonti', ar: 'تقاطع المصادر', hi: 'स्रोत पार करें', id: 'Silangkan sumber', ja: 'ソースを交差させる', ko: '소스 교차' },
  ...
  'input.add':         { fr: '+ ajouter un vécu',            en: '+ add an experience', de: '+ Erfahrung hinzufügen', es: '+ añadir experiencia', pt: '+ adicionar vivência', it: '+ aggiungi esperienza', ar: '+ إضافة تجربة', hi: '+ अनुभव जोड़ें', id: '+ tambah pengalaman', ja: '+ 経験を追加', ko: '+ 경험 추가' },
  'input.placeholder1': {
    fr: 'Collez un lien, une idée, ou racontez une histoire…',
    en: 'Paste a link, an idea, or tell a story…',
    de: 'Link, Idee einfügen oder eine Geschichte erzählen…',
    es: 'Pegar enlace, idea o contar una historia…',
    ...
    hi: 'लिंक, विचार चिपकाएँ या कहानी सुनाएँ…',
    id: 'Tempel tautan, ide, atau ceritakan kisah…',
  ...
  'input.placeholder2': {
    ...
    de: 'Die zweite Erfahrung zum Kreuzen',
    es: 'La segunda experiencia para cruzar',
    pt: 'A segunda vivência para cruzar',
    it: 'La seconda esperienza da incrociare',
    ar: 'التجربة الثانية للتقاطع',
    hi: 'पार करने के लिए दूसरा अनुभव',
    id: 'Pengalaman kedua untuk disilangkan',
    ja: '交差させる二番目の経験',
    ko: '교차할 두 번째 경험',
  },
  ...
  // ── Mode Croise-moi ──────────────────────────────────────────────────────────
  'mode.resonate':       { fr: 'Trouver un pont',   en: 'Find a bridge', de: 'Eine Brücke finden', es: 'Encontrar un puente', pt: 'Encontrar uma ponte', it: 'Trova un ponte', ar: 'البحث عن جسر', hi: 'एक पुल खोजें', id: 'Temukan jembatan', ja: '橋を見つける', ko: '다리 찾기' },
  ...
  'mode.resonate.placeholder': {
    ...
    de: 'Erzählen Sie, was Sie gerade durchmachen…',
    es: 'Cuenta lo que estás pasando ahora mismo…',
    pt: 'Conte o que você está passando agora…',
    it: 'Racconta cosa stai attraversando in questo momento…',
    ar: 'احكِ ما تمره به حالياً…',
    hi: 'बताएं कि आप अभी किस दौर से गुजर रहे हैं…',
    id: 'Ceritakan apa yang sedang Anda alami saat ini…',
    ja: '今あなたが経験していることを話してください…',
    ko: '현재 겪고 있는 일을 들려주세요…',
  },
  'mode.resonate.btn':   {
    fr: "Qui d'autre vit ça ?",
    en: 'Who else lives this?',
    de: 'Wer noch lebt das?',
    es: '¿Quién más vive esto?',
    pt: 'Quem mais vive isso?',
    it: 'Chi altro vive questo?',
    ar: 'من غيرك يعيش هذا؟',
    hi: 'और कौन यह जी रहा है?',
    id: 'Siapa lagi yang menjalani ini?',
    ja: '他に誰がこれを経験していますか？',
    ko: '또 누가 이것을 살고 있습니까?'
  },
  ...
  // ── Audit page ─────────────────────────────────────────────────────────────
  'audit.header':      { fr: 'The Experience Layer · Audit', en: 'The Experience Layer · Audit' },
  'audit.title':       { fr: 'TEL Audit',   en: 'TEL Audit' },
  'audit.subtitle':    { fr: 'Rendez lisible ce que les systèmes rendent invisible.', en: 'Make visible what systems render invisible.' },
  'audit.recent':      { fr: 'Audits récents',      en: 'Recent audits' },
  'audit.label':       { fr: 'Collez un texte à auditer', en: 'Paste text to audit' },
  'audit.placeholder': { fr: "Conditions d'utilisation, politique de confidentialité, contrat, ou tout texte institutionnel…", en: 'Terms of service, privacy policy, contract, or any institutional text…' },
  'audit.chars':       { fr: 'caractères',          en: 'characters' },
  'audit.crosswith':   { fr: 'Croiser avec',        en: 'Cross with' },
  'audit.addfree':     { fr: '+ Ajouter un texte de référence libre', en: '+ Add a free reference text' },
  'audit.freeph':      { fr: 'Collez ici votre texte de référence (convention collective, règlement interne, charte éthique…)', en: 'Paste your reference text here (collective agreement, internal rules, ethical charter…)' },
  'audit.audit':       { fr: 'Auditer ce texte',    en: 'Audit this text' },
  'audit.auditing':    { fr: 'Analyse en cours…',   en: 'Analysis in progress…' },
  'audit.back':        { fr: '← Nouvel audit',      en: '← New audit' },
  'audit.audit.label': { fr: 'Audit TEL Audit',     en: 'TEL Audit Report' },
  'audit.says':        { fr: 'Ce que le texte dit réellement', en: 'What the text actually says' },
  'audit.hides':       { fr: 'Ce que le texte cache',          en: 'What the text hides' },
  'audit.contradicts': { fr: 'Ce qui contredit les références', en: 'What contradicts the references' },
  'audit.unspeakable': { fr: "L'Indicible",         en: 'The Unspeakable' },
  'audit.question':    { fr: 'Question Inexposée',  en: 'Unexposed Question' },
  'audit.disclaimer':  { fr: "Cet audit est une version publique. Les versions institutionnelles incluent analyse clause par clause, recommandations légales et plan d'action pour la mise en conformité.", en: "This audit is a public version. Institutional versions include clause-by-clause analysis, legal recommendations and a compliance action plan." },
  'audit.share':       { fr: 'Partager',            en: 'Share' },
  'audit.copied':      { fr: '✓ Lien copié',        en: '✓ Link copied' },
  'audit.error.short': { fr: 'Le texte à auditer est trop court (minimum 50 caractères).', en: 'Text too short to audit (minimum 50 characters).' },
  'audit.error.noref': { fr: 'Sélectionnez au moins un texte de référence.', en: 'Select at least one reference text.' },
  'audit.error.generic':{ fr: "Erreur lors de l'analyse", en: 'Analysis error' },
  'audit.loading.1': { fr: 'Lecture du texte institutionnel…',            en: 'Reading institutional text…' },
  'audit.loading.2': { fr: 'Identification du jargon juridique…',          en: 'Identifying legal jargon…' },
  'audit.loading.3': { fr: 'Comparaison avec les droits fondamentaux…',    en: 'Comparing with fundamental rights…' },
  'audit.loading.4': { fr: 'Détection des clauses invisibles…',            en: 'Detecting invisible clauses…' },
  'audit.loading.5': { fr: 'Formulation de la question inexposée…',        en: 'Formulating the unexposed question…' },
  'audit.risk.low':  { fr: 'RISQUE FAIBLE',   en: 'LOW RISK' },
  'audit.risk.mod':  { fr: 'RISQUE MODÉRÉ',   en: 'MODERATE RISK' },
  'audit.risk.high': { fr: 'RISQUE ÉLEVÉ',    en: 'HIGH RISK' },
  'audit.risk.crit': { fr: 'RISQUE CRITIQUE', en: 'CRITICAL RISK' },
  ...
  'init.s4.a2':       { fr: '📰 Pour un journalist',    en: '📰 For a journalist' },
